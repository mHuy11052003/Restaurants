...
(()=>{
    const e = new Error("Cannot find module '../assets/images/logo/light-ngang'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../assets/images/logo/dark-doc'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../assets/images/logo/dark-ngang'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
const getDesignTokens = (mode)=>({
        palette: {
            ...
            ...mode === "light" ? {
                ...
                logo: {
                    open: logo_dark_ngang,
                    notOpen: logo_dark_doc
                }
            }
        },
        typography: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7a66ed._.js.map